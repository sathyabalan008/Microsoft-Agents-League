...
const defaultForm: ElectionForm = {
  electionName: "Tamil Nadu Best CM Mock Election",
  description: "MVP election flow with a default ballot preset.",
  conductedBy: "Enterprise Election Control Center",
  website: "https://example.com",
  electionType: "Political Election",
  ballotTemplate: "Political Card Layout",
  status: "Draft",
  startDate: "",
  endDate: "",
};
...
const defaultBallot: BallotOption[] = [
  {
    id: 1001,
    electionType: "Political Election",
    primary: "Indian National Congress",
    secondary: "O. P. Ramaswamy Reddiyar",
    tertiary: "Historic Leadership",
    description: "Default MVP ballot option.",
    imageUrl: "",
    displayOrder: "1",
  },
  {
  ...
  },
  {
    ...
    electionType: "Political Election",
    primary: "Indian National Congress",
    secondary: "C. Rajagopalachari (Rajaji)",
    tertiary: "Historic Leadership",
    description: "Default MVP ballot option.",
    imageUrl: "",
    displayOrder: "3",
...
const ballotCandidates: SharedCandidate[] = [
  {
    ...
    symbol: "🖐️",
    period: "1947 to 1949",
    photo: "https://via.placeholder.com/96x96.png?text=1",
  },
  {
    id: "cand-2",
    name: "P. S. Kumaraswamiraja",
    party: "Indian National Congress",
    symbol: "🖐️",
    period: "1949 to 1952",
    photo: "https://via.placeholder.com/96x96.png?text=2",
  },
  {
    id: "cand-3",
    ...
    symbol: "🖐️",
    period: "1952 to 1954",
    photo: "https://via.placeholder.com/96x96.png?text=3",
  },
];
...
function createSharedElection(form: ElectionForm, status: SharedElection["status"]): SharedElection {
  return {
    id: "tn-best-cm-mvp",
    title: "தமிழக வரலாற்றின் “சிறந்த முதலமைச்சர்” யார்?",
    subtitle: "Choose one candidate",
    status,
    totalVotes: 2,
...
export default function ElectionSetupPage() {
  ...
  function handleStartElection() {
    ...
    setMessage("Election started successfully. Ballot is live and ready.");
        ...
        <div className="rounded-3xl bg-white p-6 text-slate-900 shadow-2xl md:p-8">
          <div className="mb-8">
            ...
            <p className="mt-3 text-slate-600">
              Start, pause, or stop the election. This version also saves a shared ballot-ready election object for the public Ballot page.
            </p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <section>
              <h2 className="text-lg font-semibold text-slate-900">Election Configuration</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-slate-900">Election Schedule</h2>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <p className="text-sm font-semibold text-slate-900">Default MVP Ballot Preset</p>
              <ul className="mt-3 list-disc space-y-1 pl-5 text-sm text-slate-600">
                <li>O. P. Ramaswamy Reddiyar</li>
                <li>P. S. Kumaraswamiraja</li>
                <li>C. Rajagopalachari (Rajaji)</li>
              </ul>
            </div>
